    ...
    <div className="overflow-x-auto">
        ...
        <thead className="bg-gray-100">
          <tr>
            {columns.map((col) => (
              <th
                key={col.key}
                className="border border-gray-300 px-2 sm:px-4 py-2 text-left font-semibold whitespace-nowrap"
              >
                {col.label}
              </th>
            ))}
            <th className="border border-gray-300 px-2 sm:px-4 py-2 text-left font-semibold whitespace-nowrap">
              Actions
            </th>
          </tr>
        </thead>
                ...
                >
                  {columns.map((col) => {
                    ...
                    return (
                      <td
                        key={col.key}
                        className="border border-gray-300 px-2 sm:px-4 py-2 whitespace-nowrap"
                      >
                        {value}
                      </td>
                    );
                  ...
                  {/* Actions */}
                  <td className="border border-gray-300 px-2 sm:px-4 py-2 flex flex-wrap gap-2">
                    {type === "cancelRequest" ? (
                      <>
                        <button
                      ...
                      <>
                        ...
                        {!isDeleted && row.certificateContent && (
                          <>
                            <button
                              className="px-2 py-1 rounded bg-yellow-500 hover:bg-yellow-600 text-white text-xs"
                              onClick={(e) => {
                                e.stopPropagation();
                                setSelectedRow(row);
                                setModalMode("edit");
      ...
      {selectedRow && modalType === "certificate" && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/80 z-50">
          <div className="relative bg-white rounded-lg shadow-lg max-h-[90vh] overflow-y-auto w-[95%] sm:w-auto">
            <Certificate data={data} onClose={() => setIsModalOpen(false)} />
          </div>
        </div>
      )}
