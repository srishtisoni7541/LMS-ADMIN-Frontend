...
const RegisterPage = ({ setCurrentPage = () => {} }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden px-4 sm:px-6 lg:px-0">
      {/* Animated Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-10 right-10 w-24 sm:w-32 h-24 sm:h-32 bg-pink-500/20 rounded-full blur-xl animate-pulse"></div>
        <div className="absolute top-1/3 left-8 sm:left-20 w-36 sm:w-48 h-36 sm:h-48 bg-purple-500/20 rounded-full blur-xl animate-pulse delay-1000"></div>
        <div className="absolute bottom-20 right-1/4 w-32 sm:w-40 h-32 sm:h-40 bg-indigo-500/20 rounded-full blur-xl animate-pulse delay-2000"></div>
      ...
      <div className="relative z-10 flex flex-col lg:flex-row min-h-screen">
        {/* Left Side - Benefits & Features */}
        <div className="hidden lg:flex flex-1 flex-col justify-center items-start p-8 lg:p-12 space-y-8 overflow-y-auto">
          {/* Brand Header */}
          <div className="flex items-center space-x-3 mb-8">
            <div className="p-3 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl">
              <GraduationCap className="h-8 w-8 text-white" />
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-white">EduFlow</h1>
              <p className="text-gray-400 text-sm sm:text-base">Join thousands of learners</p>
            </div>
          </div>

          {/* Animated Benefits */}
          <div className="bg-white/5 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-white/10 w-full max-w-3xl transition-all duration-300">
            <div className="text-center">
              <div className="flex items-center justify-center mb-4">
                {React.createElement(benefits[currentBenefit].icon, {
                  className: "h-10 sm:h-12 w-10 sm:w-12 text-purple-400",
                })}
              </div>
              <div className="text-lg sm:text-xl font-bold text-white mb-2 transition-all duration-500">
                {benefits[currentBenefit].title}
              </div>
              <div className="text-gray-400 transition-all duration-500 text-sm sm:text-base">
                {benefits[currentBenefit].desc}
              </div>
            </div>
          ...
          {/* Features List */}
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-white/10 w-full max-w-3xl">
            <h3 className="text-white font-semibold mb-3 sm:mb-4 flex items-center text-sm sm:text-base">
              <Sparkles className="h-4 sm:h-5 w-4 sm:w-5 text-purple-400 mr-2" />
              What you'll get:
            </h3>
            <div className="space-y-2 sm:space-y-3">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center space-x-2 sm:space-x-3 text-xs sm:text-sm">
                  <CheckCircle className="h-3 sm:h-4 w-3 sm:w-4 text-green-400 flex-shrink-0" />
          ...
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-4 sm:p-6 border border-white/10 w-full max-w-3xl">
            <div className="text-center">
              <div className="text-gray-300 italic mb-2 sm:mb-4 transition-all duration-500 text-xs sm:text-sm">
                "{testimonials[currentTestimonial].text}"
              </div>
              <div className="text-white font-semibold transition-all duration-500 text-sm sm:text-base">
                {testimonials[currentTestimonial].name}
              </div>
              <div className="text-gray-400 text-xs sm:text-sm transition-all duration-500">
                {testimonials[currentTestimonial].role}
              </div>
            </div>
        ...
        {/* Right Side - Register Form */}
        <div className="flex-1 flex items-center justify-center p-4 sm:p-8 lg:p-8">
          <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-md sm:max-w-xl p-6 sm:p-8 border border-white/20">
            {/* Header */}
            <div className="text-center mb-6 sm:mb-8">
              <div className="lg:hidden flex items-center justify-center space-x-2 mb-4 sm:mb-6">
              ...
              <div className="flex items-center justify-center space-x-2 mt-2 sm:mt-4 text-xs sm:text-sm text-gray-500">
            ...
            <div className="space-y-4 sm:space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 sm:h-5 w-4 sm:w-5 text-gray-400" />
                  <input
                    type="text"
                    value={form.name}
                    onChange={(e) => setForm({ ...form, name: e.target.value })}
                    className="w-full pl-10 pr-10 py-2.5 sm:py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 bg-white/90 backdrop-blur-sm hover:bg-white text-sm sm:text-base"
                    placeholder="Enter your full name"
                  />
                </div>
              </div>
              ...
              <button
                type="button"
                className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2.5 sm:py-3 rounded-xl font-semibold hover:shadow-xl hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-300 relative overflow-hidden flex items-center justify-center gap-2 text-sm sm:text-base"
                onClick={handleRegister}
                disabled={isRegisterLoading}
              >
                {isRegisterLoading ? (
            ...
            <div className="my-4 sm:my-6 flex items-center">
              <div className="flex-1 border-t border-gray-300"></div>
              <div className="px-2 sm:px-4 text-xs sm:text-sm text-gray-500">or</div>
              <div className="flex-1 border-t border-gray-300"></div>
            </div>

            {/* Social Login */}
            <div className="space-y-2 sm:space-y-3">
              <button className="w-full border border-gray-300 text-gray-700 py-2.5 sm:py-3 rounded-xl hover:bg-gray-50 hover:shadow-md transition-all duration-300 flex items-center justify-center space-x-2 group text-sm sm:text-base">
            ...
            <div className="mt-6 sm:mt-8 text-center">
              ...
              <button
                onClick={() => setCurrentPage("home")}
                className="mt-2 sm:mt-4 text-xs sm:text-sm text-gray-500 hover:text-gray-700 transition-colors flex items-center justify-center space-x-1 mx-auto group"
              >
                <ArrowRight className="h-3 sm:h-4 w-3 sm:w-4 rotate-180 group-hover:-translate-x-1 transition-transform" />
                <span>Back to home</span>
              </button>
            </div>
          </div>
